...
class JoiningDetails extends ConsumerStatefulWidget {
...
class _JoiningDetailsState extends ConsumerState<JoiningDetails> {
  String _meetingId = "";
  String meetingMode = "GROUP";
  List<String> meetingModes = ["ONE_TO_ONE", "GROUP"];
  @override
  Widget build(BuildContext context) {
  final displayName = ref.watch(currentUserDetailsProvider).value!.fullName;
    ...
    return Column(
      children: [
        ...
        MaterialButton(
            ...
            color: purple,
            child: Text(widget.isCreateMeeting?"Start now":"Join now", style: TextStyle(fontSize: 16)),
            onPressed: () {
              ...
              widget.onClickMeetingJoin(
                  _meetingId.trim(), meetingMode, displayName.trim());
            }),
      ],
    );
  }
